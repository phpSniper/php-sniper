...
include "./functions/getExpiredEvents.php";
include "./functions/getNextEvent.php";
include "./functions/getTodaysEvents.php";
include "./functions/getUpcomingEvents.php";
include "./functions/getRowCount.php";
